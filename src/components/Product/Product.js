...
const Product = ({ pictureUrl, name, description, productDetails, link }) => {
  ...
  return (
    <div className="flex flex-col my-14 md:my-8 md:h-5/6 bg-gray-100 p-4 rounded-lg md:mx-5 hover:shadow">
      <div className="mx-auto text-center">
        ...
        <animated.div style={fade}>
          <img
            ...
            className="relative object-cover w-20 md:w-auto my-2 md:my-3 mx-auto"
            src={pictureUrl}
            placeholder="blurred"
            loading="lazy"
            layout="fixed"
      ...
      <button
        className="bg-gray-600 hover:bg-jaffa py-2 px-3 my-3 text-white font-semibold self-center rounded ease-linear transition-all duration-150"
        type="button"
      ...
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden  mx-4 md:mx-auto overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  ...
                  >
                    <span className="bg-gray-700 text-white opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none">
                      ×
                    </span>
                  </button>
                </div>
